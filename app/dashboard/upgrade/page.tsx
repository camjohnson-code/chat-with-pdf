    ...
    <div>
      <div className='py-20 sm:py-32'>
        <div className='max-w-5xl mx-auto text-center'>
          <h2 className='text-base font-semibold leading-7 text-customPurple'>
            Pricing
          </h2>
          ...
          <div className='max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl text-left'>
            ...
            <div className='ring-2 ring-customPurple rounded-3xl p-8'>
              <h3 className='text-lg font-semibold leading-8 text-customPurple'>
                Pro Plan
              </h3>
              <p className='mt-4 text-sm leading-6 text-gray-600'>
              ...
              <Button
                className='bg-customPurple w-full text-white shadow-sm
              hover:bg-customPurple300 mt-6 block rounded-md px-3 py-2 text-center text-sm
              font-semibold leading-6 focus-visible:outline focus-visible:outline-2
              focus-visible:outline-offset-2 focus-visible:outline-customPurple'
