...
import { BotIcon, Loader2, Loader2Icon } from 'lucide-react';
    ...
    <div className={`chat ${isHuman ? 'chat-end' : 'chat-start'}`}>
      <div className='chat-image avatar'>
        <div className='w-10 rounded-full'>
          {isHuman ? (
            ...
            <div className='h-10 w-10 bg-customPurple flex items-center justify-center'>
      ...
      <div
        className={`chat-bubble prose ${
          isHuman && 'bg-customPurple text-white'
        }`}
      >
